...
package net.mcreator.k7a2.world.biome;
...
public class K7A2BiomeBiome extends K7a2ModElements.ModElement {
	public static Biome biome;

	public K7A2BiomeBiome(K7a2ModElements instance) {
		super(instance, 174);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-655165).setWaterColor(-205).setWaterFogColor(-16764109)
						.withSkyColor(-655165).withFoliageColor(-6710785).withGrassColor(-16737895)
						.setAmbientSound(
								(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("k7a2:florentino")))
						.setMoodSound(new MoodSoundAmbience(
								(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("k7a2:magaming")), 6000, 8,
								2))
						.setAdditionsSound(new SoundAdditionsAmbience(
								(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("k7a2:smurfcat")),
								0.0111D))
						.setMusic(new BackgroundMusicSelector(
								(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("k7a2:flashmobcbh")),
								12000, 24000, true))
						.build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder().withSurfaceBuilder(
						SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(K7A2PortalBlockBlock.block.getDefaultState(),
								BlockofK7A2Block.block.getDefaultState(), BlockofK7A2Block.block.getDefaultState())));
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(K7A2WoodLogBlock.block.getDefaultState()),
								new SimpleBlockStateProvider(K7A2WoodLeavesBlock.block.getDefaultState()),
								...
								Feature.DISK
										.withConfiguration(
												new SphereReplaceConfig(Blocks.SAND.getDefaultState(), FeatureSpread.func_242253_a(2, 4), 2,
														ImmutableList.of(K7A2PortalBlockBlock.block.getDefaultState(),
																BlockofK7A2Block.block.getDefaultState())))
				...
				event.getRegistry().register(biome.setRegistryName("k7a2:k_7_a_2_biome"));
			}
		}
	}
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("k_7_a_2_biome_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("k_7_a_2_biome_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("k_7_a_2_biome_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
