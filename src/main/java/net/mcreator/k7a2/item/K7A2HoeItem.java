...
public class K7A2HoeItem extends K7a2ModElements.ModElement {
	@ObjectHolder("k7a2:k_7_a_2_hoe")
	public static final Item block = null;

	public K7A2HoeItem(K7a2ModElements instance) {
		super(instance, 54);
	}
	...
	public void initElements() {
		...
		}, 0, 6f, new Item.Properties().group(K7A2ItemGroup.tab)) {
		}.setRegistryName("k_7_a_2_hoe"));
	}
}
