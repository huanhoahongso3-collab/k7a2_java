...
public class K7A2ShovelItem extends K7a2ModElements.ModElement {
	@ObjectHolder("k7a2:k_7_a_2_shovel")
	public static final Item block = null;

	public K7A2ShovelItem(K7a2ModElements instance) {
		super(instance, 53);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("k_7_a_2_shovel"));
	}
}
