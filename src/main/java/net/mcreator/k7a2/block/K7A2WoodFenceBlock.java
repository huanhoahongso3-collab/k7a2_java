...
public class K7A2WoodFenceBlock extends K7a2ModElements.ModElement {
	@ObjectHolder("k7a2:k_7_a_2_wood_fence")
	public static final Block block = null;

	public K7A2WoodFenceBlock(K7a2ModElements instance) {
		super(instance, 163);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("k_7_a_2_wood_fence");
		}
