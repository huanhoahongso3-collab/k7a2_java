...
public class DHPhucWoodBlock extends K7a2ModElements.ModElement {
	@ObjectHolder("k7a2:dh_phuc_wood")
	public static final Block block = null;

	public DHPhucWoodBlock(K7a2ModElements instance) {
		super(instance, 177);
	}
