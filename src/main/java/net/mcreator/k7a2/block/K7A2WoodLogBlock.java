...
public class K7A2WoodLogBlock extends K7a2ModElements.ModElement {
	@ObjectHolder("k7a2:k_7_a_2_wood_log")
	public static final Block block = null;

	public K7A2WoodLogBlock(K7a2ModElements instance) {
		super(instance, 158);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("k_7_a_2_wood_log");
		}
