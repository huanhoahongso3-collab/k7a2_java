...
public class DHPhucFenceGateBlock extends K7a2ModElements.ModElement {
	@ObjectHolder("k7a2:dh_phuc_fence_gate")
	public static final Block block = null;

	public DHPhucFenceGateBlock(K7a2ModElements instance) {
		super(instance, 184);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("dh_phuc_fence_gate");
		}
