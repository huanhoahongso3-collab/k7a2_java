...
public class DHPhucLogBlock extends K7a2ModElements.ModElement {
	@ObjectHolder("k7a2:dh_phuc_log")
	public static final Block block = null;

	public DHPhucLogBlock(K7a2ModElements instance) {
		super(instance, 178);
	}
