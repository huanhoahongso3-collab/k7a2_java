...
public class K7A2WoodWoodBlock extends K7a2ModElements.ModElement {
	@ObjectHolder("k7a2:k_7_a_2_wood_wood")
	public static final Block block = null;

	public K7A2WoodWoodBlock(K7a2ModElements instance) {
		super(instance, 157);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("k_7_a_2_wood_wood");
		}
