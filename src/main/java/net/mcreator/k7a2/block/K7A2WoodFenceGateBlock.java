...
public class K7A2WoodFenceGateBlock extends K7a2ModElements.ModElement {
	@ObjectHolder("k7a2:k_7_a_2_wood_fence_gate")
	public static final Block block = null;

	public K7A2WoodFenceGateBlock(K7a2ModElements instance) {
		super(instance, 164);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("k_7_a_2_wood_fence_gate");
		}
