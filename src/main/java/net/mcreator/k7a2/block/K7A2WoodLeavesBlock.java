...
public class K7A2WoodLeavesBlock extends K7a2ModElements.ModElement {
	@ObjectHolder("k7a2:k_7_a_2_wood_leaves")
	public static final Block block = null;

	public K7A2WoodLeavesBlock(K7a2ModElements instance) {
		super(instance, 160);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("k_7_a_2_wood_leaves");
		}
