...
public class K7A2WoodPlanksBlock extends K7a2ModElements.ModElement {
	@ObjectHolder("k7a2:k_7_a_2_wood_planks")
	public static final Block block = null;

	public K7A2WoodPlanksBlock(K7a2ModElements instance) {
		super(instance, 159);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("k_7_a_2_wood_planks");
		}
