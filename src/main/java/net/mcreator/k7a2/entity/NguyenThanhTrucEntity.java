...
import net.mcreator.k7a2.entity.renderer.NguyenThanhTrucRenderer;
import net.mcreator.k7a2.K7a2ModElements;

@K7a2ModElements.ModElement.Tag
public class NguyenThanhTrucEntity extends K7a2ModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.95f)).build("nguyen_thanh_truc").setRegistryName("nguyen_thanh_truc");

	public NguyenThanhTrucEntity(K7a2ModElements instance) {
		super(instance, 35);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NguyenThanhTrucRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("nguyen_thanh_truc_spawn_egg"));
	}
